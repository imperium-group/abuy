...
<p align="center">
  <img alt="Layout" src="github/main-image/logo/abuy-logo.png">
</p>
<br/>
<h1 align="center">
  <img alt="Layout" src="github/main-image/gif/abuy-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the ABuy project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for ABuy project
</h3>
...
<p align="center">ABuy - A modern supermarket, made to your liking!</p>
...
```bash
$ git clone https://github.com/Vynny/abuy.git && cd abuy
...
```bash
# Clone your fork
$ git clone your-fork-url && cd abuy
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for ABuy project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/abuy-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/abuy-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/reset-password/abuy-reset-password.png">
</p>
...
```bash
$ git clone https://github.com/Vynny21/abuy.git && cd abuy
```
...
<h3 align="center">
  React Native Application for ABuy project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/abuy-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/Vynny21/abuy_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/Vynny21/abuy_mobile.git && cd abuy_mob
OR 
$ git clone https://github.com/Vynny21/abuy_mobile.git
...
$ gh repo fork Vynny21/abuy_mobile
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd abuy_mobile
